...
replace kinder_regular=0 if enterk==1 & regulark==0
...
replace first_regular=0 if enter1==1 & regular1==0
...
replace second_regular=0 if enter2==1 & regular2==0
...
replace third_regular=0 if enter3==1 & regular3==0
